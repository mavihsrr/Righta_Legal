...
def query():
    ...
    prompt = '''You are a multi-lingual legal expert specializing in Indian law. A user seeks your guidance 
    ...
    course of action. In the answer dont make use of '*'. ''' + user_query
